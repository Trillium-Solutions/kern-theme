...
<form name="f" action="https://jump.trilliumtransit.com/redirect.php"><input type="hidden" name="ie" value="UTF8"/><input type="hidden" name="f" value="d"/>
 ...
 <tr class="minimized-visible">
            <td valign="top"><input  type="text" alt="Start address"  name="saddr" maxlength="2048" id="saddr" placeholder="Enter your start location"/>
...
<tr class="min-hide">
<td><input  type="text" alt="Destination address" placeholder="Enter your destination" name="daddr" id="daddr" maxlength="2048"/><input type="hidden" name="sll" value="35.372915,-119.018819" />
<font size="-2">e.g. Lake Isabella Public Library</font></td></tr> 


<tr class="min-hide">
<td><font size="-1"><input type="radio" id="leave" alt="Leave at" name="ttype" value="dep" checked="checked"/><label for="leave">Depart at</label> &nbsp;or <input type="radio" alt="Arrive by at" id="arrive" name="ttype" value="arr" tabindex="1"/><label for="arrive">Arrive by</label></font></td></tr>
<tr class="min-hide">
<td><font size="-1"><input type="text" alt="Date" id="fdate" size="10" name="date" value="" maxlength="100"/>  <input type="text" id="ftime" alt="Time" size="10" name="time" value="" maxlength="100"/></font></td>
</tr>
<tr class="min-hide">
<td valign="top"><input type="submit" value="Get Directions"/></td>
</tr>
<tr >
<td>
